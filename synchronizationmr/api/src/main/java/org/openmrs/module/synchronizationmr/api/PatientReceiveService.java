 ...
 * transacción.
 */
public interface PatientReceiveService extends OpenmrsService {
	
	@Authorized(value = { "Receive Synchronization Records", "Add Patients", "Get Patients" }, requireAll = true)
	@Transactional
	long receivePatient(String eventJson);
